...
do_add(Name, Url, Args, State) ->
    ...
    AuthConfig = rebar3_hex_config:auth_config(State),
    ...
    %% Save to hex.config
    rebar3_hex_config:update_repo_auth_config(RepoConfig6, RepoName, State),
...
do_remove(Name, State) ->
    ...
    case maps:is_key(RepoName, AuthConfig) of
        true ->
            rebar3_hex_config:remove_from_auth_config(RepoName, State),
