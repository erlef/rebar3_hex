...
%%
%% ```
%% > r3h_hex_api_key:list(r3h_hex_core:default_config()).
%% {ok, {200, ..., [#{
%%     <<"authing_key">> => true,
...
%% '''
%% @end
-spec list(r3h_hex_core:config()) -> r3h_hex_api:response().
list(Config) when is_map(Config) ->
    Path = r3h_hex_api:build_organization_path(Config, ["keys"]),
...
%%
%% ```
%% > r3h_hex_api_key:get(r3h_hex_core:default_config(), <<"test">>).
%% {ok, {200, ..., #{
%%     <<"authing_key">> => true,
%%     <<"inserted_at">> => <<"2019-02-27T11:15:32Z">>,
%%     <<"last_use">> =>
...
get(Config, Name) when is_map(Config) and is_binary(Name) ->
    Path = r3h_hex_api:build_organization_path(Config, ["keys", Name]),
    r3h_hex_api:get(Config, Path).
...
%%
%% ```
%% > r3h_hex_api_key:add(r3h_hex_core:default_config(), <<"test">>, [...]).
%% {ok, {200, ..., #{
%%     <<"authing_key">> => true,
%%     <<"inserted_at">> => <<"2019-02-27T11:15:32Z">>,
%%     <<"last_use">> =>
...
%% '''
%% @end
-spec add(r3h_hex_core:config(), binary(), [permission()]) -> r3h_hex_api:response().
...
%%
%% ```
%% > r3h_hex_api_key:delete(r3h_hex_core:default_config(), <<"test">>).
%% {ok, {200, ..., #{
%%     <<"authing_key">> => true,
%%     <<"inserted_at">> => <<"2019-02-27T11:15:32Z">>,
%%     <<"last_use">> =>
...
%% '''
%% @end
-spec delete(r3h_hex_core:config(), binary()) -> r3h_hex_api:response().
...
%%
%% ```
%% > r3h_hex_api_key:delete_all(r3h_hex_core:default_config()).
%% {ok, {200, ..., [#{
%%     <<"authing_key">> => true,
%%     <<"inserted_at">> => <<"2019-02-27T11:15:32Z">>,
%%     <<"last_use">> =>
...
%% '''
%% @end
-spec delete_all(r3h_hex_core:config()) -> r3h_hex_api:response().
