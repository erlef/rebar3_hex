...
%% with modifications:
%% - Change module name to `r3h_hex_erl_tar`
...
%% - Allow setting file_info opts on :r3h_hex_erl_tar.add
...
-include_lib("r3h_hex_erl_tar.hrl").
...
safe_relative_path_links([Segment | Segments], Cwd, PrevLinks, Acc) ->
    ...
    case r3h_hex_filename:safe_relative_path(AccSegment) of
        unsafe ->
            unsafe;
